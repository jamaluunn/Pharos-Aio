...
class BrokexModule:
    ...
    async def _execute_with_retry(self, func, *args, **kwargs):
        ...
        for i in range(retries):
            try:
                ...
                # Menangkap revert di sini dan mengembalikannya untuk ditangani oleh pemanggil
    ...
    async def perform_claim_faucet(self):
        ...
        try:
            # <<< FIX DI SINI: Menangkap revert dan memberi pesan yang jelas >>>
    ...
    async def perform_trade(self, pair_id, action, amount):
        async def _trade():
            ...
            try:
                ...
                tx["gas"] = 350000
            await self._send_transaction(tx)
        await self._execute_with_retry(_trade)
